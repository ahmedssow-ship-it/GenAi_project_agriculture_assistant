...
app = typer.Typer(
    help="Evaluate agriculture instruction-tuning outputs with classic LLM metrics.",
...
JUDGE_PROMPT_TEMPLATE = """You are an evaluator for an agriculture knowledge instruction-tuned model.
