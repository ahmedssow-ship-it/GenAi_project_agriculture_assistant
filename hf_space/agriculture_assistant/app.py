...
BASE_MODEL = os.getenv("Qwen/Qwen3-0.6B", "Qwen/Qwen3-0.6B")
MODEL_REPO_ID = os.getenv("MODEL_REPO_ID", "Mumphone/agriculture-qwen3-lora")
SYSTEM_PROMPT = os.getenv(
    "SYSTEM_PROMPT",
    "You are an expert agricultural assistant helping farmers, students, and agricultural practitioners. "
    "Provide accurate, practical, and concise answers about crops, soil management, irrigation, fertilizers, "
    "pests, diseases, livestock, and sustainable farming."
)
...
demo = gr.Interface(
    ...
    description="Mumphone/agriculture-qwen3-lora",
)
